...
//
// Usage:
//   node scripts/migrate-treatments-sting-counters.js --project=dev|staging|prod [--apply]
//   node scripts/migrate-treatments-sting-counters.js --project=dev|staging|prod --delete-old-fields [--apply]
