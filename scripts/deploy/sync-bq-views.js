 ...
 * 
 * Usage:
 *   node scripts/deploy/sync-bq-views.js --diff --dev_stage    (Compare Dev and Stage)
 *   node scripts/deploy/sync-bq-views.js --deploy --dev_stage  (Sync Dev to Stage)
 *   node scripts/deploy/sync-bq-views.js --deploy --stage_prod (Sync Stage to Prod)
 */
