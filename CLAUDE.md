...
* Firebase Emulators ports for the components are seen when npm run dev:all is used to start the emulators. the ports are also seen in the emulator web console
* there is a Firebase project for staging, and a Firebase project for production
